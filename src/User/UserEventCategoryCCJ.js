    ...
    <>
      ...
      <Container maxWidth="lg">
        <div>
          ...
          <h2 style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "30px" }}>
            Upcoming Events
          </h2>
        </div>
        <div>
          <div
            style={{ display: "flex", overflowX: "hidden", maxWidth: "100%" }}
            ref={containerRef}
          >
            {event.map((event, index) => (
              ...
              >
                ...
                {new Date(event.date) >= currentDate &&
                  (event.department === "CCJ" || event.department === "None") &&
                  event.status === 1 &&
                  event.isDeleted === 0 && (
                    <Link
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <Button onClick={scrollLeft}>
              <img src="/img/leftbtn.png" alt="left" />
            </Button>
            <Button onClick={scrollRight}>
              <img src="/img/rightbtn.png" alt="left" />
            </Button>
          </div>
        </div>
